      ...
      <div class="filter-left">
        ...
        >
          <el-option
            ...
            :key="patient.id"
            :label="patient.name + ' - ' + (patient.gender || '') + ', ' + (patient.age || '') + '岁, 医生: ' + (patient.doctorName || '未分配')"
            :value="patient.id"
          />
        </el-select>
      </div>
...
const fetchHistory = async () => {
  ...
  try {
    ...
    const res = await request.get('/tcm/results/history', { params })
